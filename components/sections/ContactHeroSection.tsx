...
export function ContactHeroSection({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-navy-0 via-navy-1 to-navy-2 pt-[140px] pb-[90px]">
      <div className="absolute inset-0 grid-pattern" />
      <div className="glow-orb w-[380px] h-[380px] bg-accent/12 -top-24 right-0" />

      <div className="relative max-w-[820px] mx-auto px-[24px] md:px-[40px] lg:px-[80px] text-center">
        ...
        <p className="font-body font-normal text-[19px] leading-[1.75] text-muted max-w-[600px] mx-auto">
          {subtitle}
        </p>
      </div>
    </section>
